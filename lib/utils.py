...
def Evaluate4Classes(test,model,path,episode_max_len=300,window_size=8,subject=1):
    ...
    test_results.to_csv(path+'/4Classes_Test_Result_Sogg{}.csv'.format(s))
    model.save(path+'/4Classes_TunedModel_Sogg{}'.format(s))



def Evaluate3Classes(test,model,path,episode_max_len=300,window_size=8,subject=1):
    ...
    test_results['y_pred'] = y_pred
    test_results['classification_time'] = classification_time
    test_results.to_csv(path+'/3Classe_Test_Result_Sogg{}.csv'.format(s))
    model.save(path+'/3Classe_mlp_TunedModel_Sogg{}'.format(s))
